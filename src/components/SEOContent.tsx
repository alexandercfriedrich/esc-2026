    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <ol className="list-decimal list-inside mb-6 space-y-2">
          ...
          <li><a href="#vienna-host-city" className="text-primary hover:underline">Vienna - The Host City</a></li>
          <li><a href="#complete-hotel-guide" className="text-primary hover:underline">Complete Hotel Guide</a></li>
          <li><a href="#booking-information" className="text-primary hover:underline">Booking Information</a></li>
        </ol>
        ...
        <ul className="list-disc list-inside mb-4 space-y-1">
          ...
          <li><strong>Semi-Final 2:</strong> Thursday, May 14, 2026</li>
          <li><strong>Grand Final:</strong> Saturday, May 16, 2026</li>
        </ul>
        <p className="mb-2"><strong>Venue:</strong> Wiener Stadthalle, Vienna, Austria</p>
        <p className="mb-2"><strong>Expected Attendance:</strong> 200,000+ international visitors</p>
        ...
        <ul className="list-disc list-inside mb-6 space-y-2">
          ...
          <li><strong>Sustainability Focus:</strong> Environmentally conscious event organization</li>
          <li><strong>Cultural Integration:</strong> Showcasing Austrian and Viennese culture</li>
          <li><strong>Digital Innovation:</strong> Advanced streaming and interactive features</li>
        </ul>
        ...
        <ul className="list-disc list-inside mb-4 space-y-1">
          ...
          <li><strong>Tram Lines:</strong> 6, 52, 60 directly to the venue</li>
          <li><strong>Bus Connections:</strong> Multiple city bus lines</li>
          <li><strong>Taxi/Rideshare:</strong> Widely available throughout Vienna</li>
        </ul>

        <p className="mb-4"><strong>For International Visitors:</strong></p>
        <ul className="list-disc list-inside mb-6 space-y-1">
          <li><strong>Vienna International Airport:</strong> 45 minutes via CAT (City Airport Train) + U6</li>
          <li><strong>Central Station:</strong> 20 minutes via U1 + U6 connection</li>
        ...
        <ul className="list-disc list-inside mb-6 space-y-2">
          ...
          <li><strong>Accessibility:</strong> Full wheelchair access and assistance services</li>
          <li><strong>Parking:</strong> 2,000+ parking spaces in adjacent garages</li>
          <li><strong>Security:</strong> Professional event security and bag checks</li>
        </ul>
        ...
        <p className="mb-4"><strong>Cultural Diversity:</strong></p>
        <p className="mb-4">
        ...
        <p className="mb-4"><strong>Tourism Infrastructure:</strong></p>
        <p className="mb-6">
        ...
        <ul className="list-disc list-inside mb-4 space-y-1">
          ...
          <li><strong>Hofburg Palace:</strong> Former imperial residence, now museums and offices</li>
          <li><strong>Schönbrunn Palace:</strong> Baroque palace with magnificent gardens</li>
        </ul>

        <p className="mb-4"><strong>Cultural Highlights:</strong></p>
        <ul className="list-disc list-inside mb-4 space-y-1">
          <li><strong>Belvedere Palace:</strong> Home to Klimt's "The Kiss" and other masterpieces</li>
          <li><strong>Kunsthistorisches Museum:</strong> One of the world's finest art museums</li>
          <li><strong>Naschmarkt:</strong> Vienna's most popular market with international cuisine</li>
        </ul>

        <p className="mb-4"><strong>Modern Vienna:</strong></p>
        <ul className="list-disc list-inside mb-6 space-y-1">
          <li><strong>Prater:</strong> Giant Ferris wheel and amusement park</li>
          <li><strong>Danube Island:</strong> Recreation area with beaches and events</li>
        ...
        <p className="mb-6"><strong>Cultural Events:</strong> Museums, galleries, and venues hosting Eurovision-themed exhibitions</p>
        ...
        <ol className="list-decimal list-inside mb-6 space-y-2">
          ...
          <li><strong>Reserve Early:</strong> Eurovision dates book quickly - advance booking recommended</li>
          <li><strong>Confirm Details:</strong> Verify dates, rates, and cancellation policies</li>
        ...
        <p className="mb-4">
          <strong>Advance Booking:</strong> Most Eurovision hotels become available for booking 12-18 months in advance. Early booking often secures better rates.
        </p>
        <p className="mb-4">
          <strong>Cancellation Policies:</strong> Review hotel cancellation terms carefully, as Eurovision period bookings may have stricter policies.
        </p>
        <p className="mb-6">
        ...
        <ul className="list-disc list-inside mb-4 space-y-1">
          ...
          <li><strong>Tram Networks:</strong> Multiple tram lines serve the venue area</li>
          <li><strong>Night Services:</strong> Extended public transport during Eurovision events</li>
        </ul>

        <p className="mb-4"><strong>Walking Distances:</strong> Several hotels are within comfortable walking distance:</p>
        <ul className="list-disc list-inside mb-6 space-y-1">
          <li><strong>Under 10 minutes:</strong> Boutiquehotel Stadthalle, Hotel Regina</li>
          <li><strong>10-20 minutes:</strong> Hotel Am Konzerthaus, Ruby Marie, ART HOTEL Vienna</li>
        ...
        <ul className="list-disc list-inside mb-4 space-y-1">
          ...
          <li><strong>S7 S-Bahn:</strong> Direct service to central Vienna stations</li>
          <li><strong>Taxi/Uber:</strong> Available but more expensive during Eurovision week</li>
        </ul>

        <p className="mb-4"><strong>Concert Tickets:</strong> This platform provides hotel information only. Official Eurovision tickets are sold through:</p>
        <ul className="list-disc list-inside mb-6 space-y-1">
          <li><strong>Official Eurovision Website</strong></li>
          <li><strong>Authorized ticket vendors</strong></li>
          <li><strong>ORF (Austrian broadcaster)</strong></li>
        </ul>
        ...
        <p className="mb-4"><strong>Important Legal Information:</strong></p>
        <ul className="list-disc list-inside mb-6 space-y-2">
          <li><strong>Not affiliated</strong> with Eurovision Song Contest, European Broadcasting Union (EBU), ORF, or any official Eurovision organization</li>
          <li><strong>No direct bookings</strong> - all hotel reservations must be made through official hotel websites or established booking platforms</li>
          <li><strong>Information accuracy</strong> not guaranteed - always verify hotel details, prices, and availability directly with hotels</li>
          <li><strong>Affiliate links</strong> may be used for booking platforms (booking.com, hotels.com) to support this fan project</li>
          <li><strong>Personal project</strong> created by Alexander Friedrich for the Eurovision community</li>
          <li><strong>Price estimates</strong> based on historical Eurovision data and may vary significantly</li>
        </ul>
        ...
        <p className="mb-4">
          ...
          <strong>Next Update:</strong> Regular updates as Eurovision 2026 approaches
        </p>
